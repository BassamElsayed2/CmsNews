    ...
    fields: [
      // ===== Header Title =====
      {
        ...
        fields: [
          ...
          { name: "ar", title: "Arabic", type: "string", validation: Rule => Rule.required() },
        ],
      },
        ...
        fields: [
          ...
          },
          {
            ...
            options: {
              ...
              slugify: input => {
                ...
                return `${input.toLowerCase().replace(/\s+/g, "-").replace(/[^a-z0-9-]/g, "")}-${randomNum}`.slice(0, 90);
              },
          ...
          },
          {
            ...
            fields: [
              ...
              { name: "ar", title: "Arabic", type: "text", validation: Rule => Rule.required() },
            ],
          },
          {
            name: "category",
      ...
      // ===== Other Cards =====
      {
        ...
        validation: Rule => Rule.min(4).error("You must add at least 4 feature cards."),
      },
